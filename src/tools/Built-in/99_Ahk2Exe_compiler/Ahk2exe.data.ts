...
export type TAhk2exeDataElement = {
    keyRawName: string,
    body: string,
...
export const Ahk2exeData: readonly TAhk2exeDataElement[] = [
    ...
    },
    {
        ...
        doc: [
            'Adds a resource to the compiled executable. (Also see [UseResourceLang](https://www.autohotkey.com/docs/v1/misc/Ahk2ExeDirectives.htm#UseResourceLang) below)',
        ],
    ...
    },
    {
        ...
        doc: [
            'Specifies the location and name given to the generated .exe file. (Also see the [Base](https://www.autohotkey.com/docs/v1/misc/Ahk2ExeDirectives.htm#Bin) directive.) This directive may be overridden by an output file specified in the GUI or CLI.',
        ],
    ...
    },
    {
        ...
        doc: [
            'Creates (or modifies) one or more user variables which can be accessed by `%U__Name_%`, similar to the built-in variables (see above).',
        ],
    ...
    },
    {
        ...
        link: 'https://www.autohotkey.com/docs/v1/misc/Ahk2ExeDirectives.htm#SetProp',
        doc: [
            'Changes the [language code](https://www.autohotkey.com/docs/v1/misc/Languages.htm). Please note that hexadecimal numbers must have an `0x` prefix.',
        ],
    ...
    },
    {
        ...
        link: 'https://www.autohotkey.com/docs/v1/misc/Ahk2ExeDirectives.htm#UpdateManifest',
        doc: [
            'Changes the resource language used by [AddResource](https://www.autohotkey.com/docs/v1/misc/Ahk2ExeDirectives.htm#AddResource). This directive is positional and affects all [AddResource](https://www.autohotkey.com/docs/v1/misc/Ahk2ExeDirectives.htm#AddResource) directives that follow it.',
        ],
