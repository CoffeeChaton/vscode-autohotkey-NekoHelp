...
export const ObjFile: readonly TBiObj[] = [
    ...
    },
    {
        ...
        doc: [
            ...
            '',
            '_NumType_ is either UInt, Int, Int64, Short, UShort, Char, UChar, Double, or Float. These type names have the same meanings as with [DllCall()](https://www.autohotkey.com/docs/v1/lib/DllCall.htm#types).',
            '',
            '- Return Value',
            'On success, this method returns a number. On failure, it returns an empty string.',
            '',
            '- Remarks',
            'If a [Try](https://www.autohotkey.com/docs/v1/lib/Try.htm) statement is active and no bytes were read, an exception is thrown. However, no exception is thrown if at least one byte was read, even if the size of the given _NumType_ is greater than the number of bytes read. Instead, the missing bytes are assumed to be zero.',
        ],
    },
    {
        keyRawName: 'ReadInt()',
    ...
    },
    {
        ...
        doc: [
            ...
            '',
            '- Return Value',
            'This method returns the number of bytes that were written. For example, `File.WriteUInt(42)` returns 4 if successful.',
        ],
    },
    {
        keyRawName: 'WriteInt()',
