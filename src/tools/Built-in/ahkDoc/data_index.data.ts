...
// form GPL-V2 <https://github.com/AutoHotkey/AutoHotkeyDocs/blob/v1/docs/static/source/data_index.js>
 ...
 *
        ...
        99 - Ahk2Exe compiler
 */
export type TIndexData = [string, string, number?, string?];

export const indexData: TIndexData[] = [
    ...
    ['button state', 'lib/GetKeyState.htm#function'],
    ...
    ['key state', 'lib/GetKeyState.htm#function'],
