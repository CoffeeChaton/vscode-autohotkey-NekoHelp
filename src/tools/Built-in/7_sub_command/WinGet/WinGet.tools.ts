...
export const WinGet_snip: readonly vscode.CompletionItem[] = temp_WinGet.snippetListRW;
export const WinGet_MDMap: ReadonlyMap<string, vscode.MarkdownString> = temp_WinGet.MDMapRW;
